...
type SectionType = "modes" | "themes" | "sizes" | "constraints" | "localization";

const Home = () => {
  // Active Section State
  const [activeSection, setActiveSection] = useState<SectionType>("modes");
  ...
  const [customDisabledDate, setCustomDisabledDate] = useState<Date | null>(
    new Date(),
  );
  ...
  // French locale
  const frenchLocale = {
    weekDays: ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam"] as [
      string,
      string,
      string,
      string,
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-linear-to-br from-blue-50 to-indigo-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto">
            A beautiful, feature-rich calendar component for React. Multiple
            themes, flexible selection modes, and extensive customization
            options.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 sm:px-6 py-2 sm:py-3 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition-colors text-sm sm:text-base"
            >
              GitHub
            </a>
          </div>
          ...
          >
            <div className="space-y-6 sm:space-y-8 w-full">
              <div className="flex flex-col items-center">
                ...
                <Calendar
                  disablePastDates
                  selectedDate={noPastDate}
                  onDateChange={setNoPastDate}
                />
              </div>
              <div className="flex flex-col items-center">
                <h4 className="text-sm font-semibold text-gray-500 mb-3 text-center">
                ...
                <Calendar
                  disableFutureDates
                  selectedDate={noFutureDate}
                  onDateChange={setNoFutureDate}
                />
              </div>
            </div>
          </CalendarSection>
          ...
          >
            <div className="space-y-6 sm:space-y-8 w-full">
              <div className="flex flex-col items-center">
                ...
                <Calendar
                  disableWeekends
                  selectedDate={noWeekendsDate}
                  onDateChange={setNoWeekendsDate}
                />
              </div>
              <div className="flex flex-col items-center">
                <h4 className="text-sm font-semibold text-gray-500 mb-3 text-center">
                  Custom Disabled (15th of month)
                </h4>
                <Calendar
                  isDateDisabled={isDateDisabled}
                  selectedDate={customDisabledDate}
                  onDateChange={setCustomDisabledDate}
                />
              </div>
            </div>
          </CalendarSection>
